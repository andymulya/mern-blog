...
const TextInputIcon = ({ type, name, id, placeholder, style, children }) => {
    const [passwordVisible, setPasswordVisible] = useState(true)
    
    return (
        <div className="relative">
            <input type={ (type == "password") && passwordVisible ? type : "text" } name={ name } id={ id } placeholder={ placeholder } className={`input w-full rounded-md border-0 py-3 bg-blue-100 placeholder:text-gray-700 pl-16 ${ style }`} />
