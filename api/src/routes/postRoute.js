...
import { createPost, getLatestBlog, getTrendingBlogs, getAllBlogsCount, searchBlogs, getBlog, updateBlog, likeBlog } from '../controllers/postController.js'
...
router.patch('/like-blog', verifyToken, likeBlog)
